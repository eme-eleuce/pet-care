...
<div class="container  py-6 mx-auto items-center justify-center">
<div class="flex text-center mb-16 items-center justify-center">
<a href="#_" class="relative   inline-block  md:px-[7rem] px-20 md:py-8 py-6 overflow-hidden text-rose-600 rounded-lg  group">
<span class="absolute top-0 left-0 w-[16rem] h-[16rem] -mt-10 -ml-6 transition-all duration-700 bg-[#EE4266] rounded-full blur-md ease"></span>
<span class="absolute inset-0 w-full h-full transition duration-700 group-hover:rotate-180 ease">
<span class="absolute bottom-0 left-0 w-[16rem] h-[16rem] -ml-7 bg-teal-500 rounded-full blur-md"></span>
<span class="absolute bottom-0 right-0 w-[16rem] h-[16rem] -mr-20 bg-[#ffda61] rounded-full blur-md"></span>
</span>
<span class="relative text-white font-bold text-2xl">Book here</span>
</a>
    </div>
    </div>
  </div>
