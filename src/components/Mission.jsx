...
<span className="absolute top-0 left-0 w-[16rem] h-[16rem] -mt-10 -ml-6 transition-all duration-700 bg-[#EE4266] rounded-full blur-md ease"></span>
<span className="absolute inset-0 w-full h-full transition duration-700 group-hover:rotate-180 ease">
<span className="absolute bottom-0 left-0 w-[16rem] h-[16rem] -ml-7 bg-teal-500 rounded-full blur-md"></span>
<span className="absolute bottom-0 right-0 w-[16rem] h-[16rem] -mr-20 bg-[#ffda61] rounded-full blur-md"></span>
</span>
